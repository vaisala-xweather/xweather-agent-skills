...
The Apple SDK also supports **fewer** layers than the JS SDK (182 vs. 283). If a layer exists
in the JS catalog and not here, it is not available on Apple platforms — that is a real gap, not a
naming problem.
