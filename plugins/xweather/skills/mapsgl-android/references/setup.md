...
Read against the SDK's Gradle files, library manifest and constructors at the `release/1.6.1`
tag. The getting-started page is secondary when it disagrees - it still shows the deprecated
